<template>
  <div class="page">
    <div class="newSchool" v-loading="loading">
      <!-- 保存按钮 -->
      <div class="page-header" :class="[ collapse ? 'collapse-200' : 'collapse-64' ]">                                                         
        <el-button type="primary" @click="formSubmit('form')">保存编辑</el-button>
      </div>
      <el-row :gutter="20">
        <el-col :xs="24" :sm="24" :md="20" :lg="18" :xl="18">
          <el-form :rules="rules" ref="form" :model="form" status-icon size="small" :label-width="formLabelWidth">
            ...
            <el-row :gutter="5">
              ...
              <el-col :span="8">
                <el-form-item label="学校标签" prop="labelIds">
                  <el-select v-model="form.labelIds" value-key="labelId" multiple collapse-tags placeholder="请选择学校标签" style="width:100%">
                    <el-option
            ...
            <!-- for -->  
            <el-form-item>
              <el-button icon="el-icon-plus" size="mini" type="primary" @click="handleAddlinkMan">新增联系人</el-button>
            </el-form-item>    
            <el-form-item label="学校简介" prop="description">
              <el-input type="textarea" v-model="form.description" placeholder="请输入学校简介" :rows="4"></el-input>
            </el-form-item>  
            <el-form-item label="栏目模板" prop="channelTemplateId">
              <el-select v-model="form.channelTemplateId" placeholder="请选择栏目播放模板" disabled>
                <el-option
